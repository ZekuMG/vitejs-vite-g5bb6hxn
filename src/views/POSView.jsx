...
import {
  ...
  ScanBarcode,
  User, 
  Gift,       // Icono para Canje
  UserMinus
} from 'lucide-react';
import { PAYMENT_METHODS } from '../data';
// Importamos formatPrice desde helpers (según tu estructura)
...
export default function POSView({
  ...
  setSelectedClient,
  onOpenClientModal,
  // Nueva prop para canje (usada sutilmente)
  ...
  return (
    <div className="flex h-full overflow-hidden bg-slate-100 relative">
      ...
      {/* ========================================== */}
      {/* COLUMNA IZQUIERDA: CATÁLOGO (Igual)        */}
      {/* ========================================== */}
      ...
      {/* ========================================== */}
      {/* COLUMNA DERECHA: CARRITO (Estilo CLARO restaurado) */}
      {/* ========================================== */}
      <div className="w-[380px] bg-white border-l flex flex-col shadow-2xl z-20 shrink-0">
        ...
        <div className="p-5 bg-slate-50 border-t space-y-4">
          ...
          {/* --- SECCIÓN CLIENTE (DISEÑO CLARO RESTAURADO) --- */}
          <div className={`bg-white border rounded-xl p-3 shadow-sm transition-colors ${selectedClient ? 'border-fuchsia-200 bg-fuchsia-50/30' : 'border-slate-200'}`}>
        ...
        <div className="absolute inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in">
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 text-center transform scale-100 transition-all border border-slate-200">
            ...
            <div className="space-y-3">
              ...
              <button onClick={confirmCheckoutWithoutClient} className="w-full py-3 bg-white border-2 border-slate-200 text-slate-500 hover:text-slate-700 hover:bg-slate-50 rounded-xl font-bold transition-colors">No, continuar compra</button>
            </div>
          </div>
        </div>
      )}
