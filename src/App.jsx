  ...
  const handleCheckout = () => {
    ...
    if (posSelectedClient) {
      ...
      clientSnapshot = {
        ...
        memberNumber: posSelectedClient.memberNumber,
        name: posSelectedClient.name,
        identifier: posSelectedClient.dni || posSelectedClient.phone,
    ...
    const tx = {
      ...
      pointsGainedReal: pointsEarned
    };

    setTransactions([tx, ...transactions]);
    addLog('Venta Realizada', { transactionId: tx.id, total: total, client: clientSnapshot ? clientSnapshot.name : 'Invitado' }, 'Venta regular');
